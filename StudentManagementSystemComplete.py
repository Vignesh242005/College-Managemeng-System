def addstudent():
    ...
    emaillabel = Label(addroot,text='Enter Mail Id: ',bg='cyan',font=('times',20,'bold'),relief=GROOVE,borderwidth=3,width=12,anchor='w')
...
DataEntryFrame = Frame(root,bg='dodgerblue4',relief=GROOVE,borderwidth=5)
DataEntryFrame.place(x=10,y=80,width=500,height=600)
frontlabel = Label(DataEntryFrame,text='MENU',width=30,font=('arial',22,'italic bold'),bg='gray')
...
################################################################################################################  Slider
ss = 'College Management System For AIE'
count = 0
text = ''
##################################
SliderLabel = Label(root,text=ss,font=('chiller',30,'italic bold'),borderwidth=4,width=35,bg='dodgerblue4')
SliderLabel.place(x=120,y=0)
...
connectbutton = Button(root,text='Connect To Database',width=18,font=('chiller',19,'italic bold'),relief=RIDGE,borderwidth=4,bg='skyblue3',
